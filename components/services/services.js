            ...
            <div className="spacer feature4">
                <Container>
                    ...
                    <Row className="m-t-40">
                        {services.map((ele, key) => <Col md="6" className="wrap-feature4-box" key={key}>
                            <Card>
                                <CardBody>

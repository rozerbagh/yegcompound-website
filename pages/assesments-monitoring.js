                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col md="7" className="text-center">
                                <h1 className="title font-bold">Always keeping an eye on your progress</h1>
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col md="7" className="text-center">
                                ...
                                <h6 className="subtitle">
                                    Your pharmacist can prescribe and execute certain tests to make sure your treatment is working for you. 
                                    They will also help you keep your condition in check with monitoring tools and advice.
                                </h6>
                            </Col>
                        </Row>
                        <section>

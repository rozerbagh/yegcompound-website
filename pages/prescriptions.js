...
import {
    ...
    CardTitle,
    Col,
    Container, Form, Nav, NavItem, NavLink, Row, TabContent, TabPane
} from "reactstrap";
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col md="7" className="text-center">
                                ...
                                <h6 className="subtitle">
                                    Prescription services are at the core of what your pharmacist does.
                                    See how these services can benefit you.
                                </h6>
                            </Col>
                        </Row>
                        <section>
                                    ...
                                    <Card>
                                        <Row>
                                            ...
                                            <Col md="4" className="text-center">
                                                <a href="tel:403.235.0888" className="text-white linking bg-info">
                        ...
                        <Row className="justify-content-center">
                            <Col md="7" className="text-center">
                                ...
                                <h6 className="subtitle">
                                Do you need to take medication for a new or temporary condition?
                                Here's what your pharmacist can do for you if you are struggling with a minor health problem. 
                                </h6>
                            </Col>
                        </Row>
                    </Container>

                        ...
                        <Row className="justify-content-center">
                            <Col md="7" className="text-center">
                                ...
                                <h6 className="subtitle">
                                    ...
                                    your therapy or provide you with custom formulas and innovative 
                                    packaging to make it all easier. 
                                </h6>
                            </Col>
                        </Row>
                    </Container>
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col md="7" className="text-center">
                                ...
                                <h6 className="subtitle">
                                    When it comes to medication, you can choose how it is given and presented to you. 
                                    Here’s what your pharmacist can do.
                                </h6>
                            </Col>
                        </Row>
                        <section>
